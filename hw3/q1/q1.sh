...
bin/hadoop jar ngram/NGram.jar NGram -Dngram.n=2 -Dngram.m=20 /reddit_titles/ /reddit_output/ngram
...
echo "---------------------------------------"
echo "Q7: Report number of trigrams(n=3) occur at least 100 times"
bin/hadoop jar ngram/NGram.jar NGram -Dngram.n=3 -Dngram.m=100 /reddit_titles/ /reddit_output/tringram
echo "Number of trigrams(n=3) occur at least 100 times"
